...
const SecondaryActionButton = ({action,clickHandler, icon }:{action: string, clickHandler: MouseEventHandler<HTMLButtonElement>,icon?: ReactNode}) => {
  return(
    <button className={`transition duration-100 ease-linear rounded-xl hover:bg-gray-700 flex justify-start min-h-11 py-2 px-2 w-full whitespace-nowrap`} onClick={clickHandler}>
